...
// TODO добавить оставшиеся страницы (голос мафии, голос детектива, голос доктора, переход на день и показ убитых, голос граждан, 
// показ изгананых, победитель, комната ожидания), дописать все методы на беке, добалять в группу по ролям